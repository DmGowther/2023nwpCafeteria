...
<section class="container-m row px-4 py-4">
  ...
  <form action="index.php?page=Products_Product&mode={{~mode}}&productId={{productId}}" method="POST"
    ...
    <div class="row my-2 align-center">
      ...
      <input class="col-12 col-m-9" readonly disabled type="text" name="productIdD" id="productIdD" placehoder="Código"
        value="{{productId}}" />
    ...
    <div class="row my-2 align-center">
      ...
      <input class="col-12 col-m-9" {{~readonly}} type="number" name="productPrice" id="productPrice" placehoder=""
        value="{{productPrice}}" />
